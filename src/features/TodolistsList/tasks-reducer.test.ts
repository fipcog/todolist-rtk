...
test('correct task should be deleted from correct array', () => {
    const action = tasksThunks.removeTask.fulfilled({ taskId: "2", todolistId: "todolistId2" }, 'todolistId2', { taskId: "2", todolistId: "todolistId2" });
...
test('correct task should be added to correct array', () => {
    ...
    }, 'todolistId2', { title: 'sad', todolistId: 'sdf' });
...
test('status of specified task should be changed', () => {
    const action = tasksThunks.updateTask.fulfilled(
        ...
        "todolistId2", {
        taskId: "2", domainModel: { status: TaskStatuses.New },
        todolistId: "todolistId2"
    });
...
test('propertry with todolistId should be deleted', () => {
    const action = todolistThunks.removeTodolist.fulfilled({ id: "todolistId2" }, 'sfsdf', 'sfsdfsd');
...
test('tasks should be added for todolist', () => {
    const action = tasksThunks.fetchTasks.fulfilled({ tasks: startState["todolistId1"], todolistId: "todolistId1" }, 'sdfsd', 'sdfsdf');
